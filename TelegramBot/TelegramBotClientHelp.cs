...
/// </summary>
[PublicAPI]
public class TelegramBotClientHelp : ITelegramBotClient
{
    ...
    /// <summary>
    /// Create a new <see cref="TelegramBotClientHelp"/> instance.
    /// </summary>
    /// <param name="options">Configuration for <see cref="TelegramBotClientHelp" /></param>
    /// <param name="httpClient">A custom <see cref="HttpClient"/></param>
    /// <exception cref="ArgumentNullException">
    /// Thrown if <paramref name="options"/> is <c>null</c>
    /// </exception>
    public TelegramBotClientHelp(
...
#pragma warning restore CA2000
        ...
        if (OnMakingApiRequest is not null)
        {
            ...
            await OnMakingApiRequest.Invoke(
                botClient: (ITelegramBotClient)this,
